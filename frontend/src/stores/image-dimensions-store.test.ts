...
describe("image-dimensions-store", () => {
  ...
  describe("getDimension", () => {
    it("should return undefined for non-existent src", () => {
      const dim = useImageDimensionsStore
        .getState()
        .getDimension("nonexistent");
    ...
    it("should return dimension for existing src", () => {
      ...
      const dim = useImageDimensionsStore
        .getState()
        .getDimension("https://example.com/img.jpg");
      expect(dim).toEqual({
        src: "https://example.com/img.jpg",
        width: 800,
        height: 600,
  ...
  describe("setDimension", () => {
    it("should set dimension for src", () => {
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/img.jpg", 1920, 1080);
    ...
    it("should calculate correct aspect ratio", () => {
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/square.jpg", 500, 500);

      const dim = useImageDimensionsStore
        .getState()
        .getDimension("https://example.com/square.jpg");
    ...
    it("should overwrite existing dimension", () => {
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/img.jpg", 100, 100);
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/img.jpg", 200, 100);
    ...
    it("should not affect other dimensions", () => {
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/img1.jpg", 100, 100);
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/img2.jpg", 200, 100);

      const dim1 = useImageDimensionsStore
        .getState()
        .getDimension("https://example.com/img1.jpg");
      const dim2 = useImageDimensionsStore
        .getState()
        .getDimension("https://example.com/img2.jpg");
  ...
  describe("markFailed", () => {
    it("should mark image as failed", () => {
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/broken.jpg");

      const state = useImageDimensionsStore.getState();
      expect(state.failedImages.has("https://example.com/broken.jpg")).toBe(
        true,
      );
    });
    ...
    it("should mark multiple different images as failed", () => {
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/broken1.jpg");
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/broken2.jpg");
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/broken3.jpg");

      const state = useImageDimensionsStore.getState();
      expect(state.failedImages.size).toBe(3);
      expect(state.failedImages.has("https://example.com/broken1.jpg")).toBe(
        true,
      );
      expect(state.failedImages.has("https://example.com/broken2.jpg")).toBe(
        true,
      );
      expect(state.failedImages.has("https://example.com/broken3.jpg")).toBe(
        true,
      );
    });
  });
  ...
  describe("isFailed", () => {
    it("should return false for non-failed image", () => {
      const result = useImageDimensionsStore
        .getState()
        .isFailed("https://example.com/good.jpg");
    ...
    it("should return true for failed image", () => {
      ...
      const result = useImageDimensionsStore
        .getState()
        .isFailed("https://example.com/broken.jpg");
  ...
  describe("loadFromDB", () => {
    ...
    it("should set isLoading during load", async () => {
      ...
      const loadPromise = useImageDimensionsStore
        .getState()
        .loadFromDB(["src1"]);
    ...
    it("should merge loaded dimensions with existing ones", async () => {
      ...
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/existing.jpg", 50, 50);

      await useImageDimensionsStore
        .getState()
        .loadFromDB(["https://example.com/img1.jpg"]);

      const state = useImageDimensionsStore.getState();
      expect(
        state.dimensions["https://example.com/existing.jpg"],
      ).toBeDefined();
  ...
  describe("clearFailed", () => {
    ...
    it("should not affect cached dimensions", () => {
      useImageDimensionsStore
        .getState()
        .setDimension("https://example.com/img.jpg", 800, 600);
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/broken.jpg");
    ...
    it("should allow previously failed images to be retried", () => {
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/img.jpg");
      expect(
        useImageDimensionsStore
          .getState()
          .isFailed("https://example.com/img.jpg"),
      ).toBe(true);
  ...
  describe("BUG: iOS PWA failed image repeated loading", () => {
    ...
    it("failedImages Set should maintain state independent of component lifecycle", () => {
      ...
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/img1.jpg");
      useImageDimensionsStore
        .getState()
        .markFailed("https://example.com/img2.jpg");
    ...
    it("failed state should be checked before attempting to load image", () => {
      ...
      const isFailed = useImageDimensionsStore
        .getState()
